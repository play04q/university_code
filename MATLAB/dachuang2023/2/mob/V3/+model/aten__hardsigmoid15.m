classdef aten__hardsigmoid15 < nnet.layer.Layer & nnet.layer.Formattable & ...
        nnet.layer.AutogeneratedFromPyTorch
    %aten__hardsigmoid15 Auto-generated custom layer
    ...
    methods
        function obj = aten__hardsigmoid15(Name, Type, InputNames, OutputNames)
            obj.Name = Name;
            obj.Type = Type;
            obj.NumInputs = 1;
            obj.NumOutputs = 1;
