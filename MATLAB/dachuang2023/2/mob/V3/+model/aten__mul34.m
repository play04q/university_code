classdef aten__mul34 < nnet.layer.Layer & nnet.layer.Formattable
    %aten__mul34 Auto-generated custom layer
    ...
    methods
        function obj = aten__mul34(Name, Type, InputNames, OutputNames)
            obj.Name = Name;
            obj.Type = Type;
            obj.NumInputs = 3;
            obj.NumOutputs = 1;
        ...
        function [mul_input_1] = predict(obj,mul_24, mul_argument1_1, mul_24_rank)
            ...
            if ~contains(dims(mul_argument1_1),'U')
                ...
                warning(message('nnet_cnn_pytorchconverter:pytorchconverter:PossibleLossOfRank', 'mul_argument1_1', 'aten__mul34'));
            end
