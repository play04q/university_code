...
% This fimction calculates the SNR fluctuation loss for Swerling models % A negative Lf value indicates SNR gain instead of loss 
format long 
...
if(np==1)
    ...
    % np > 1 use MATLAB function pd _swerling5.m
    snr_inc = 0.1-0.005; 
    Pd_Sw5 = 0.001; 
    while(Pd_Sw5 <= pd)
        snr_inc=snr_inc + 0.005; 
