% Use this program to reproduce 2.20 of text. close all 
clear all;
close all;
np = 4; 
pfa = 1e-7; 
...
Ia = improv_fac(np,pfa,pda); % caculate the integration loss
Lm = 10*log10(np)-Im; 
La = 10*log10(np)-Ia; 
pt = 11.47e3; %peak power in Watts 
...
b = 1.0e6; % radar operating bandwidth in Hz 
